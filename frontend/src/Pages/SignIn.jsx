      ...
      <div className="relative w-full max-w-md bg-white/90 backdrop-blur-lg rounded-3xl shadow-2xl p-8 border border-white/20">
        ...
        <div className="flex justify-center mb-6 space-x-4">
          <button
            ...
            className={`px-4 py-2 rounded-full font-medium transition-colors duration-300 ${role === "patient"
          ...
          <button
            ...
            className={`px-4 py-2 rounded-full font-medium transition-colors duration-300 ${role === "doctor"
                ? "bg-emerald-600 text-white shadow-md"
                : "bg-white text-gray-700 border border-gray-300 hover:bg-emerald-50"
              } cursor-pointer`}
          >
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="relative">
            <label
              htmlFor="email"
              className={`absolute left-4 transition-all duration-300 pointer-events-none ${isFocused.email || email
          ...
          <div className="relative">
            <label
              htmlFor="password"
              className={`absolute left-4 transition-all duration-300 pointer-events-none ${isFocused.password || password
                  ? 'top-1 text-xs text-emerald-600 font-medium'
                  : 'top-3 text-gray-500 text-sm'
                }`}
            >
          ...
          <button
            ...
            className="w-full py-3 cursor-pointer border border-emerald-500 text-emerald-600 font-medium rounded-xl hover:bg-emerald-50 transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500"
          >
            Try Demo Account
          </button>
        </form>
