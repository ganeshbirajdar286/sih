  ...
  const features = [
    {
      ...
      description:
        "Secure access with role-based permissions for practitioners and patients",
    },
    {
      title: "Patient Management Profiles",
      description:
        "Comprehensive patient tracking with health history and progress monitoring",
    },
    {
      title: "Food Database (8000+ items)",
      description:
        "Extensive database with detailed nutritional and Ayurvedic properties",
    },
    {
    ...
    },
    {
      ...
      description:
        "Complete meal plans with automatic nutritional calculations",
    },
    {
      title: "Printable Reports (PDF-ready)",
      description:
        "Professional reports for patients with actionable recommendations",
    },
  ];
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-emerald-50 via-amber-50 to-slate-50">
      ...
      <nav className="flex justify-between items-center px-6 md:px-8 py-5 shadow-sm bg-white/90 backdrop-blur-sm sticky top-0 z-40">
        ...
        <div className="hidden md:flex space-x-3">
          <button
            className="px-4 py-2 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-lg hover:from-green-700 hover:to-emerald-700 transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 cursor-pointer"
            onClick={() => navigate("/signup")} // redirect to SignUp page
          >
            Sign Up
          </button>
          <button
            className="px-4 py-2 bg-gradient-to-r from-gray-800 to-gray-900 text-white rounded-lg hover:from-gray-900 hover:to-black transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 cursor-pointer"
      ...
      <header className="flex flex-col md:flex-row items-center justify-between px-8 py-16 md:py-24 relative overflow-hidden">
        ...
        <div className="max-w-xl space-y-6 relative z-10">
          ...
          <p className="text-lg text-gray-600 leading-relaxed">
            ...
            Rasa, Hot/Cold properties, digestion ease, and personalized dosha
            balancing for optimal health and wellness.
          </p>
          <div className="flex flex-wrap gap-4">
            <button className="px-6 py-3 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-lg hover:from-green-700 hover:to-emerald-700 transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 cursor-pointer"  onClick={() => {
                navigate("/signup"); // redirect
                setMenuOpen(false);
              }}>
              Create Account
      ...
      <section className="px-8 py-16 bg-white relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-lg text-gray-600 text-center mb-12 max-w-2xl mx-auto">
            Our platform combines ancient Ayurvedic wisdom with modern
            technology to deliver personalized dietary recommendations.
          </p>
            ...
            {features.map((feature, idx) => (
              ...
              >
                ...
                >
                  <span
                    className={`text-xl ${
                      activeFeature === idx ? "text-white" : "text-green-600"
                    }`}
                  >
                    {idx + 1}
                  </span>
      ...
      <section className="px-8 py-16 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Join thousands of Ayurvedic practitioners who are modernizing their
            practice with our powerful diet management platform.
          </p>
          <button
            className="px-8 py-4 bg-gradient-to-r from-green-600 to-emerald-600 text-white text-lg font-semibold rounded-xl hover:from-green-700 hover:to-emerald-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 cursor-pointer"
            onClick={() => {
                navigate("/signin"); // redirect
                setMenuOpen(false);
              }}
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-6 relative animate-scaleIn">
            ...
            <div className="text-center mb-2">
              ...
              <p className="text-gray-600 mt-2">
                {isSignup
                  ? "Join our Ayurvedic community today"
